    ...
    <style>
        * {
        ...
        body {
            ...
            background-size: 400% 400%; /* Sửa lỗi cú pháp: bỏ ký tự | */
        ...
        /* Loại bỏ overlay màu */
        .banner::after {
            display: none; /* Giữ nguyên màu tự nhiên của ảnh */
        }
        ...
        .banner-content {
            ...
            width: 90%;
            color: white;
            background: rgba(255, 255, 255, 0.2); /* Nền mờ để tăng độ tương phản */
            backdrop-filter: blur(8px); /* Hiệu ứng mờ để chữ nổi bật hơn */
            border-radius: 15px;
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); /* Thêm bóng để tạo chiều sâu */
        }
        ...
        .banner h1 {
            ...
            font-weight: 700;
            margin-bottom: 20px;
            text-shadow: 0 6px 12px rgba(0, 0, 0, 0.8); /* Tăng text-shadow để chữ nổi bật */
        ...
        .banner p {
            ...
            font-weight: 300;
            margin-bottom: 30px;
            text-shadow: 0 4px 8px rgba(0, 0, 0, 0.8); /* Tăng text-shadow */
        }
