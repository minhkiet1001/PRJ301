...
<head>
    ...
    <style>
        * {
        ...
        header {
            background: linear-gradient(45deg, #5DC1B9, #F7DC6F); /* Gradient từ code đầu tiên */
            color: white;
            padding: 10px 50px;
            position: fixed;
            top: 0;
        ...
        .logo {
            font-size: 28px;
            font-weight: 700;
            font-family: 'Pacifico', cursive; /* Font từ code đầu tiên */
        ...
        .nav-links a:hover, .nav-links a:focus {
            ...
            color: #F8E1A1; /* Vàng nhạt khi hover từ code đầu tiên */
        ...
        .notification-count {
            ...
            padding: 2px;
            border: 2px solid #F7DC6F; /* Viền vàng nhạt đồng bộ với gradient */
        }
        ...
        .login-btn {
            ...
            font-size: 14px;
            font-weight: 600;
            background: linear-gradient(45deg, #F7DC6F, #F1C40F); /* Gradient vàng từ code đầu tiên */
            color: white;
            position: relative;
            overflow: hidden;
            transition: all 0.3s ease;
