...
<head>
    ...
    <style>
        /* CSS giữ nguyên như code bạn gửi */
        * {
            margin: 0;
            padding: 0;
                ...
                <div class="room-info-section">
                    ...
                    <div class="room-reviews">
                        ...
                        <div class="review-form">
                            ...
                            <form action="submit-review" method="post" onsubmit="return checkLogin()">
                            ...
                            <p id="login-message" style="color: red; margin-top: 10px; display: none;">Vui lòng đăng nhập để đánh giá!</p>
                        </div>
...
<script>
    ...
    function checkLogin() {
        // Tạo biến JavaScript từ JSP để kiểm tra trạng thái đăng nhập
