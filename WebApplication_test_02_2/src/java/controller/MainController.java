...
public class MainController extends HttpServlet {
    ...
    public void search(HttpServletRequest request, HttpServletResponse response)
        ...
        List<BookDTO> books = bookDAO.searchByTile2(searchTerm);
            ...
            if(action == null){
                ...
                if(action.equals("login")){
                    ...
                    if(isValidLogin(strUserID, strPassword)){
                        url = "search.jsp";
                        UserDTO user = (UserDTO) getUser(strUserID);
                        request.getSession().setAttribute("user", user);
                        //search
                        url = "search.jsp";
                        search(request, response);
                    }else{
                        request.setAttribute("massage", "Incorrect UserID or Password");
                        url= "login.jsp";
                    ...
                    try {
                        ...
                        if(quantity <0){
                            checkError = true;
                            request.setAttribute("txtBookID_error", "Quantity >=0");
                        }
